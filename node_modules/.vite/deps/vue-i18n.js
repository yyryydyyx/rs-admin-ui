import {
  require_vue
} from "./chunk-DYK4MZYW.js";
import "./chunk-NFRVYK3K.js";
import {
  __commonJS,
  __esm,
  __export,
...
__export(core_base_esm_browser_exports, {
  ...
  CORE_ERROR_CODES_EXTEND_POINT: () => CORE_ERROR_CODES_EXTEND_POINT,
  CORE_WARN_CODES_EXTEND_POINT: () => CORE_WARN_CODES_EXTEND_POINT,
...
var hasWarned, inBrowser, mark, measure, RE_ARGS, generateFormatCacheKey, friendlyJSONstringify, isNumber, isDate, isRegExp, isEmptyObject, assign, _create, create, hasOwnProperty, isArray, isFunction, isString, isBoolean, isObject, isPromise, objectToString, toTypeString, isPlainObject, toDisplayString, RANGE, CompileErrorCodes, COMPILE_ERROR_CODES_EXTEND_POINT, errorMessages$1, RE_HTML_TAG, detectHtmlTag, CHAR_SP, CHAR_CR, CHAR_LF, CHAR_LS, CHAR_PS, EOF, DOT, LITERAL_DELIMITER, ERROR_DOMAIN$3, ERROR_DOMAIN$2, KNOWN_ESCAPES, TEXT_ESCAPES, ERROR_DOMAIN$1, ERROR_DOMAIN, generate, PROPS_BODY, PROPS_CASES, PROPS_STATIC, PROPS_ITEMS, PROPS_TYPE, PROPS_VALUE, PROPS_MODIFIER, PROPS_KEY, AST_NODE_PROPS_KEYS, WARN_MESSAGE, defaultOnCacheKey, compileCache, devtools, translateDevTools, CoreErrorCodes, CORE_ERROR_CODES_EXTEND_POINT, errorMessages, _resolveLocale, pathStateMachine, literalValueRE, cache, CoreWarnCodes, CORE_WARN_CODES_EXTEND_POINT, warnMessages, VERSION, NOT_REOSLVED, DEFAULT_LOCALE, MISSING_RESOLVE_VALUE, capitalize, _compiler, _resolver, _fallbacker, _additionalMeta, setAdditionalMeta, getAdditionalMeta, _fallbackContext, setFallbackContext, getFallbackContext, _cid, createResources, intlDefined, Availabilities, DATETIME_FORMAT_OPTIONS_KEYS, NUMBER_FORMAT_OPTIONS_KEYS, DEFAULT_MODIFIER, DEFAULT_MESSAGE, DEFAULT_MESSAGE_DATA_TYPE, DEFAULT_NORMALIZE, DEFAULT_INTERPOLATE, NOOP_MESSAGE_FUNCTION, isMessageFunction;
var init_core_base_esm_browser = __esm({
  "node_modules/@intlify/core-base/dist/core-base.esm-browser.js"() {
    ...
    CORE_WARN_CODES_EXTEND_POINT = 10;
    warnMessages = {
    ...
    _cid = 0;
    createResources = (locale) => ({ [locale]: create() });
...
__export(shared_esm_browser_exports, {
  ...
  format: () => format2,
  friendlyJSONstringify: () => friendlyJSONstringify2,
  generateCodeFrame: () => generateCodeFrame2,
  generateFormatCacheKey: () => generateFormatCacheKey2,
  ...
  sanitizeTranslatedHtml: () => sanitizeTranslatedHtml2,
  toDisplayString: () => toDisplayString2,
  toTypeString: () => toTypeString2,
  warn: () => warn2,
  warnOnce: () => warnOnce2
});
...
var hasWarned2, inBrowser2, mark2, measure2, RE_ARGS2, makeSymbol, generateFormatCacheKey2, friendlyJSONstringify2, isNumber2, isDate2, isRegExp2, isEmptyObject2, assign2, _create2, create2, _globalThis, getGlobalThis, hasOwnProperty2, isArray2, isFunction2, isString2, isBoolean2, isSymbol, isObject2, isPromise2, objectToString2, toTypeString2, isPlainObject2, toDisplayString2, RANGE2, isNotObjectOrIsArray;
...
var require_vue_i18n = __commonJS({
  "node_modules/vue-i18n/dist/vue-i18n.cjs"(exports) {
    ...
    var I18nErrorCodes = {
      ...
      UNEXPECTED_RETURN_TYPE: coreBase.CORE_ERROR_CODES_EXTEND_POINT,
      // 24
    ...
    function createComposer(options = {}) {
      ...
      function te(key, locale2) {
        return wrapWithDeps(() => {
          ...
          const locales = shared.isString(locale2) ? [targetLocale] : coreBase.fallbackWithLocaleChain(_context, _fallbackLocale.value, targetLocale);
          for (let i = 0; i < locales.length; i++) {
            ...
            if (coreBase.isMessageAST(resolved) || coreBase.isMessageFunction(resolved) || shared.isString(resolved)) {
              return true;
            }
          }
          return false;
